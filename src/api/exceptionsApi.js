...
/** GET /cargoRoute/exception/getException/:id → RequiredResponseDTO */
export const getExceptionById = (id) =>
  axios.get(`${BASE_URL}/cargoRoute/exception/getException/${id}`).then((r) => r.data);
...
/** PATCH /cargoRoute/exception/updateExceptionStatus/:id?status=STATUS → ExceptionRecordDTO */
export const updateExceptionStatus = (id, status) =>
  axios
    .patch(`${BASE_URL}/cargoRoute/exception/updateExceptionStatus/${id}`, null, {
      params: { status },
    })
    .then((r) => r.data);

/** GET /cargoRoute/exception/getExceptionByBooking/:bookingId → List<RequiredResponseDTO> */
export const getExceptionsByBooking = (bookingId) =>
  axios
    .get(`${BASE_URL}/cargoRoute/exception/getExceptionByBooking/${bookingId}`)
    .then((r) => r.data);
...
/** GET /cargoRoute/claim/getClaim/:id → ClaimDTO */
export const getClaimById = (id) =>
  axios.get(`${BASE_URL}/cargoRoute/claim/getClaim/${id}`).then((r) => r.data);
...
/** PATCH /cargoRoute/claim/updateClaimStatus/:id?status=STATUS → ClaimDTO */
export const updateClaimStatus = (id, status) =>
  axios
    .patch(`${BASE_URL}/cargoRoute/claim/updateClaimStatus/${id}`, null, {
      params: { status },
    })
    .then((r) => r.data);

/** GET /cargoRoute/claim/getClaimByException/:exceptionId → List<ClaimDTO> */
export const getClaimsByException = (exceptionId) =>
  axios
    .get(`${BASE_URL}/cargoRoute/claim/getClaimByException/${exceptionId}`)
    .then((r) => r.data);
