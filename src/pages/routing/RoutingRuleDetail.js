      ...
      <div className="routing-container routing-rule-detail-page">
        ...
        <div className="detail-header">
          ...
          <div className="detail-actions">
            ...
            <button className="btn-secondary icon-action-btn" onClick={() => navigate('/routing/rules')}>
          ...
          {!isEditing ? (
            ...
            <div className="form-card routing-rule-edit-form">
              ...
              <div className="form-actions">
                ...
                <button className="btn btn-secondary form-btn-short" onClick={handleCancel} disabled={saving}>
                  Cancel
                </button>
              </div>
            </div>
