...
import Layout from '../../../../Sneha frontend/src/components/Layout';
        ...
        <div className="detail-header">
          ...
          <div className="detail-actions">
            {!isEditing ? (
              ...
              <>
                <button className="btn-delete icon-btn" onClick={() => { setIsEditing(false); setFormData(load); }}>
                  <span className="icon-btn-icon">✕</span>
                  <span className="icon-btn-label">Cancel</span>
                </button>
